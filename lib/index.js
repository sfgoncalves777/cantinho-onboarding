...
if (!['stepOne', 'stepTwo', 'stepThree'].includes(processStep)) {
...
if (['stepTwo', 'stepThree'].includes(processStep) && tenant.includes('test')) {
  console.log(`É proibido rodar o ${processStep} com configurações de testes.`);
  return;
}
