...
const buildReplaces = (company, theme) => {
  ...
  const pageLogin = {
    ...
    js: {
      urlBaseLogin: process.env.INTENT === 'test' ? process.env.URL_BASE_LOCAL : process.env.URL_BASE_PRD_LOGIN
    }
  }
  ...
  const pageRegisterRent = {
    ...
    js: {
      urlBaseGetProperties: process.env.INTENT === 'test' ? process.env.URL_BASE_LOCAL : process.env.URL_BASE_PRD_GET_ALL_PROPERTIES
    }
  }
  ...
  const pageCreateRent = {
    ...
    js: {
      urlBaseCreateProperty: process.env.INTENT === 'test' ? process.env.URL_BASE_LOCAL : process.env.URL_BASE_PRD_CREATE_PROPERTY,
      urlBaseFinishProperty: process.env.INTENT === 'test' ? process.env.URL_BASE_LOCAL : process.env.URL_BASE_PRD_FINISH_PROPERTY,
  ...
  const pageEditRent = {
    ...
    js: {
      urlBaseUpdateProperty: process.env.INTENT === 'test' ? process.env.URL_BASE_LOCAL : process.env.URL_BASE_PRD_EDIT_PROPERTY,
      urlBaseFinishProperty: process.env.INTENT === 'test' ? process.env.URL_BASE_LOCAL : process.env.URL_BASE_PRD_FINISH_PROPERTY,
      urlBaseDeleteProperty: process.env.INTENT === 'test' ? process.env.URL_BASE_LOCAL : process.env.URL_BASE_PRD_DELETE_PROPERTY,
      urlBaseGetProperty: process.env.INTENT === 'test' ? process.env.URL_BASE_LOCAL : process.env.URL_BASE_PRD_GET_PROPERTY,
      citiesAndDistricts: JSON.stringify(company.citiesAndDistricts)
    }
  }
  const pageEditSale = {
